<?php
$link_text = get_post_meta($post->ID, "mg_simple_banners_text", true);
...
<table class="form-table mg_simple_banners_meta_box">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="mg_simple_banners_text" id="mg_simple_banners_text" class="regular-text link-text" value="<?php echo isset(
                                                                                                                                    $link_text
                                                                                                                                )
                                                                                                                                    ? esc_html($link_text)
                                                                                                                                    : ""; ?>" required>
    ...
    <tr>
        ...
        <td>
            <input type="url" name="mg_simple_banners_url" id="mg_simple_banners_url" class="regular-text link-url" value="<?php echo isset(
                                                                                                                                $link_url
                                                                                                                            )
                                                                                                                                ? esc_url($link_url)
                                                                                                                                : ""; ?>" required>
